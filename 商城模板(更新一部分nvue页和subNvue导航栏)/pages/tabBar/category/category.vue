		...
		<view class="category-list">
			...
			<scroll-view  scroll-y="true" class="right" >
			    <view class="category" v-for="(category,index) in categoryList" :key="category.id" v-show="index==showCategoryIndex" >
					<view class="banner">
						<image :src="category.title_img"></image>
					</view>
					<view class="list">
						<view class="box" v-for="(box,i) in category.child" :key="i" @tap="toCategory(box)">
							<image :src="box.title_img"></image>
...
<script>
	export default {
		...
		methods: {
			randerCategory () {
				this.$http.post('api/get/goods/category').then(res=> {
					console.log(res)
